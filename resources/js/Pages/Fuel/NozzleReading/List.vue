        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb align-items-center ">
                    ...
                    <li v-if="CheckPermission(Section.NOZZLE_READING + '-' + Action.CREATE)" style="margin-left: auto;"><router-link :to="{name: 'NozzleReadingAdd'}"><i class="fa-solid fa-plus"></i> Add Nozzle Reading</router-link></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12">
                                            ...
                                            <tr v-for="f in listData">
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-end">
                                                        <router-link v-if="CheckPermission(Section.NOZZLE_READING + '-' + Action.EDIT)" :to="{name: 'NozzleReadingEdit', params: { id: f.id }}" class=" btn btn-primary shadow btn-xs sharp me-1">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </router-link>
                                                        <a v-if="CheckPermission(Section.NOZZLE_READING + '-' + Action.DELETE)" href="javascript:void(0)"  @click="openModalDelete(f)" class="btn btn-danger shadow btn-xs sharp">
