        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb align-items-center ">
                    ...
                    <li v-if="CheckPermission(Section.TANK + '-' + Action.CREATE)" style="margin-left: auto;"><router-link :to="{name: 'TankAdd'}"><i class="fa-solid fa-plus"></i> Add New Tank</router-link></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12">
