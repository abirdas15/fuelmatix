        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb align-items-center ">
                    ...
                    <li v-if="CheckPermission(Section.EMPLOYEE + '-' + Action.CREATE)"  style="margin-left: auto;"><router-link :to="{name: 'employeeAdd'}"><i class="fa-solid fa-plus"></i> Add New Employee</router-link></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12">
                                    ...
                                    <div class="dataTables_wrapper no-footer">
                                        ...
                                        <table class="display  dataTable no-footer" style="min-width: 845px">
                                            ...
                                            <tr class="text-white" style="background-color: #4886EE;color:#ffffff">
                                                <th class="text-white" @click="sortData('rfid')" :class="sortClass('rfid')">RFID</th>
                                                <th class="text-white" @click="sortData('name')" :class="sortClass('name')">Name</th>
                                                <th class="text-white" @click="sortData('position')" :class="sortClass('position')">Position</th>
                                                <th class="text-white" @click="sortData('salary')" :class="sortClass('salary')">Salary</th>
                                            ...
                                            <tr v-for="f in listData">
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-end">
                                                        ...
                                                        <a v-if="CheckPermission(Section.EMPLOYEE + '-' + Action.DELETE)"   href="javascript:void(0)"  @click="openModalDelete(f)" class="btn btn-danger shadow btn-xs sharp">
...
export default {
    ...
    methods: {
        ...
        Delete: function (data) {
            ApiService.POST(ApiRoutes.employeeDelete, {id: data.id },res => {
                if (parseInt(res.status) === 200) {
