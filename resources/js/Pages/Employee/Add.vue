                            ...
                            <form @submit.prevent="save">
                                ...
                                <div class="row" style="text-align: right;">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <router-link :to="{name: 'employee'}" type="button" class="btn btn-primary">Cancel</router-link>
                                    </div>
                                </div>
                            </form>
                        </div>
...
export default {
    ...
    methods: {
        save: function () {
            ...
            this.loading = true
            ApiService.POST(ApiRoutes.employeeAdd, this.param,res => {
                this.loading = false
    ...
    mounted() {
        $('#dashboard_bar').text('Employee Add')
    }
}
</script>
