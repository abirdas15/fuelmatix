                                            ...
                                            <tr v-for="f in listData">
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-end">
                                                        <router-link :to="{name: 'salaryEdit', params: { id: f.id }}" class=" btn btn-primary shadow btn-xs sharp me-1">
...
export default {
    ...
    methods: {
        ...
        list: function (page) {
            ...
            ApiService.POST(ApiRoutes.salaryList, this.Param,res => {
        ...
        Delete: function (data) {
            ApiService.POST(ApiRoutes.salaryDelete, {id: data.id },res => {
                if (parseInt(res.status) === 200) {
