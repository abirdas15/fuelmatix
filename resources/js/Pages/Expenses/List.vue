        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li style="margin-left: 66%;"><router-link :to="{name: 'ExpenseAdd'}"><i class="fa-solid fa-plus"></i> Add New Expense</router-link></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12">
...
export default {
    ...
    methods: {
        ...
        Delete: function (data) {
            ApiService.POST(ApiRoutes.ExpenseDelete, {id: data.id },res => {
                if (parseInt(res.status) === 200) {
