        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb align-items-center ">
                    ...
                    <li class="breadcrumb-item active"><router-link :to="{name: 'Pos'}">Dummy Sale</router-link></li>
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Dummy Sale View</h4>
                    </div>
                    <div class="card-body">
...
export default {
    ...
    methods: {
        getSingle: function () {
            ApiService.POST(ApiRoutes.DummySaleSingle, {id: this.id},res => {
