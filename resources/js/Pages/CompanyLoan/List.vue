        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb align-items-center ">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Company Loan List</a></li>
                    <li v-if="CheckPermission(Section.COMPANY_LOAN + '-' + Action.CREATE)" style="margin-left: auto;"><router-link :to="{name: 'CompanyLoanAdd'}"><i class="fa-solid fa-plus"></i> Add New Company Loan</router-link></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-secondary">
                            <h4 class="card-title">Company Loan List</h4>
                        </div>
                        <div class="card-body">
                            <div class="row mt-4">
                                    ...
                                    <div class="dataTables_wrapper no-footer">
                                        ...
                                        <table class="display  dataTable no-footer" style="min-width: 845px">
                                            ...
                                            <tr class="text-white" style="background-color: #4886EE;color:#ffffff">
                                                <th class="text-white" @click="sortData('staff_name')" :class="sortClass('staff_name')">Company Name</th>
                                            ...
                                            <tr v-for="f in listData">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <router-link :to="{name: 'CompanyLoanView', params: {id: f.account_id}}"  class="btn btn-info shadow btn-sm sharp">
                                                            <i class="fa fa-eye"></i>
                                                        </router-link>
                                                    </div>
                                                </td>
...
export default {
    ...
    methods: {
        payment: function () {
            this.Loading = true
            ApiService.POST(ApiRoutes.CompanyLoan + '/payment', this.paymentParam,res => {
                this.Loading = false
        ...
        list: function (page) {
            ...
            ApiService.POST(ApiRoutes.CompanyLoan + '/list', this.Param,res => {
