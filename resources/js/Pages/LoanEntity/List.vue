                                    ...
                                    <div class="dataTables_wrapper no-footer">
                                        ...
                                        <table class="display  dataTable no-footer" style="min-width: 845px">
                                            ...
                                            <tr class="text-white" style="background-color: #4886EE;color:#ffffff">
                                                <th class="text-white" @click="sortData('name')" :class="sortClass('name')">Entity Name</th>
...
export default {
    ...
    methods: {
        ...
        list: function (page) {
            ...
            ApiService.POST(ApiRoutes.EntityList, this.Param,res => {
        ...
        Delete: function (data) {
            ApiService.POST(ApiRoutes.EntityDelete, {id: data.id },res => {
                if (parseInt(res.status) === 200) {
    ...
    mounted() {
        $('#dashboard_bar').text('Entity List')
    }
}
</script>
